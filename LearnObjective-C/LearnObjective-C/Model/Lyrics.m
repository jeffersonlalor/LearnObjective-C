...
//        UIImage *myimage = [[UIImage alloc] initWithContentsOfFile: @"default-image"];
        ...
        lyric = [[Lyrics alloc] initWithName: @"Meus Próprios Meios" band: @"Oficina G3" image: [UIImage imageNamed: @"coracao-de-aco"] lyricsSong: @"I Don't Have Now!"];
        [lyrics addObject: lyric];

        lyric = [[Lyrics alloc] initWithName: @"Depois da Guerra" band: @"Oficina G3" image: [UIImage imageNamed: @"diario-de-um-banana"] lyricsSong: @"I Don't Have Now!"];
        [lyrics addObject: lyric];

        lyric = [[Lyrics alloc] initWithName: @"A Ele" band: @"Oficina G3" image: nil lyricsSong: @"I Don't Have Now!"];
        [lyrics addObject: lyric];
